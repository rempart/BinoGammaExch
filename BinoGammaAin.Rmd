...
author: "Eric Parent"
date: "13 janvier partie 1 : Prévision binaire sur Vouglans"
fontsize: 9pt
includes:
...
J'ai recommencé l'étude sur toute la'année en posant saison $=1:365$. Le prédicteur naif passe alors devant avec un score de Brier de $0.149$ contre $0.156$ pour le bayésien, mais une composante de fiabilité plus mauvaise, de $0.02$ contre $0.00598$ pour le bayésien, néanmoins compensée par une résolution de $0.121$ contre $0.1$ pour le bayésien.