...
On trouve $\rho$= `r ro`, une valeur très proche de la proportion empirique `r sum(d$Obs>seuil)/length(d$Obs)`.
...
Il faut adopter la climatologie, c'est à dire la valeur de la probabilité marginale $[Y=1]$. Ceci doit faire l'objet d'une discussion car on dispose d'une base historique.
...
Reste maintenant à passer à la prévision de la quantité de pluie, ce qui fera l'objet d'une autre note. Le modèle des fuites échangeable est également à envisager.